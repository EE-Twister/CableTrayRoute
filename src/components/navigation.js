const NAV_ROUTES = [
  ...
  { href: 'samplegallery.html', label: 'Sample Gallery', section: 'Workflow', group: 'Planning', icon: 'icons/toolbar/grid.svg' },
  { href: 'workflowdashboard.html', label: 'Project Dashboard', section: 'Workflow', group: 'Planning', icon: 'icons/toolbar/grid.svg' },
  { href: 'bimcoordination.html', label: 'BIM Coordination', section: 'Workflow', group: 'Planning', icon: 'icons/toolbar/connect.svg' },
  ...
  { href: 'productcatalog.html', label: 'Product Catalog', section: 'Library', icon: 'icons/toolbar/grid.svg' },
  ...
  { href: 'cablethermal.html', label: 'Cable Thermal Environment', section: 'Studies', group: 'Cable', icon: 'icons/cable.svg' },
  ...
  { href: 'optimalpowerflow.html', label: 'Optimal Power Flow', section: 'Studies', group: 'Power System', icon: 'icons/load.svg' },
