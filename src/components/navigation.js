...
export const NAV_ROUTES = [
  ...
  { href: 'datamanager.html', label: 'One-Line Data Manager', section: 'Workflow', group: 'Planning', icon: 'icons/toolbar/grid.svg' },
  { href: 'switchingprocedures.html', label: 'Switching Procedures', section: 'Workflow', group: 'Planning', icon: 'icons/components/Breaker.svg' },
  ...
  { href: 'substationlayout.html', label: 'Substation Layout Generator', section: 'Studies', group: 'Structural', icon: 'icons/toolbar/grid.svg' },
  ...
  { href: 'lightningprotection.html', label: 'Lightning & Surge Protection', section: 'Studies', group: 'Grounding', icon: 'icons/toolbar/validate.svg' },
  ...
  { href: 'cybercompliance.html', label: 'Cyber Compliance', section: 'Studies', group: 'Protection', icon: 'icons/toolbar/validate.svg' },
