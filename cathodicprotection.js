...
import { parseZoneResistivityValues } from './src/studies/cp/distributionModel.js';
export { evaluateCriteriaChecks } from './src/studies/cp/criteriaChecks.js';
import { parseMitigationActions } from './src/studies/cp/interferenceAssessment.js';
import { COATING_MODEL_TYPES, parseConditionFactorValues } from './src/studies/cp/coatingModel.js';
import {
  CP_STANDARD_BASIS,
  buildCpProfileData,
...
import {
  runCathodicProtectionAnalysis as runCathodicProtectionAnalysisOffMain
...
function normalizeAnalysisInput(candidate) {
  ...
  const validationErrors = validateCathodicProtectionInputs(normalized);
