...
const dataStoreCalls = {
  ...
  getDeliverableArtifacts: ['read', 'settings.deliverableArtifacts'],
  setDeliverableArtifacts: ['write', 'settings.deliverableArtifacts'],
  upsertDeliverableArtifact: ['write', 'settings.deliverableArtifacts'],
  getFieldExecutionRecords: ['read', 'settings.fieldExecutionRecords'],
  setFieldExecutionRecords: ['write', 'settings.fieldExecutionRecords'],
  getProcurementRegister: ['read', 'settings.procurementRegister'],
  setProcurementRegister: ['write', 'settings.procurementRegister'],
