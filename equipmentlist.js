  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    initNavToggle();
      ...
      const columns = [
        ...
        { key: 'catalogNumber', label: 'Catalog #', type: 'text' },
        { key: 'standard', label: 'Standard', type: 'text' },
        { key: 'interruptRatingKa', label: 'AIC (kA)', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'withstandRatingKa', label: 'Withstand (kA)', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'withstandCycles', label: 'Withstand Cycles', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'sccrKa', label: 'SCCR (kA)', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'busBracingKa', label: 'Bus Bracing (kA)', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'shortTimeRatingKa', label: 'Short-Time (kA)', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'enclosure', label: 'Enclosure', type: 'text' },
        { key: 'temperatureRatingC', label: 'Temp Rating (C)', type: 'number', step: 'any', validate: 'numeric' },
        { key: 'protectiveDeviceId', label: 'Protective Device ID', type: 'text' },
    ...
    const fieldMap = {
      ...
      'Standard': 'standard',
      'AIC (kA)': 'interruptRatingKa',
      'Interrupting Rating kA': 'interruptRatingKa',
      'interruptRatingKa': 'interruptRatingKa',
      'Withstand (kA)': 'withstandRatingKa',
      'Withstand Rating kA': 'withstandRatingKa',
      'withstandRatingKa': 'withstandRatingKa',
      'Withstand Cycles': 'withstandCycles',
      'withstandCycles': 'withstandCycles',
      'SCCR (kA)': 'sccrKa',
      'SCCR kA': 'sccrKa',
      'sccrKa': 'sccrKa',
      'Bus Bracing (kA)': 'busBracingKa',
      'Bus Bracing kA': 'busBracingKa',
      'busBracingKa': 'busBracingKa',
      'Short-Time (kA)': 'shortTimeRatingKa',
      'Short-Time Rating kA': 'shortTimeRatingKa',
      'shortTimeRatingKa': 'shortTimeRatingKa',
      'Enclosure': 'enclosure',
      'Temperature Rating C': 'temperatureRatingC',
      'temperatureRatingC': 'temperatureRatingC',
      'Protective Device ID': 'protectiveDeviceId',
      'protectiveDeviceId': 'protectiveDeviceId',
      'One-Line Ref': 'oneLineRef',
