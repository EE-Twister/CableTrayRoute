...
const tccRendererScript = await readFile(new URL('../analysis/tcc/chartRenderer.mjs', import.meta.url), 'utf8');
...
assert.match(tccRendererScript, /tcc-fuse-tolerance-band/);
assert.match(tccRendererScript, /tcc-equipment-tag-callout/);
