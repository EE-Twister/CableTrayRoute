...
const attributeDisplayOverrides = {
  ...
  volts: { label: 'Nameplate Voltage', unit: 'V' },
  ...
  baseKV: { label: 'Analysis Base Voltage', unit: 'kV' },
  kV: { label: 'Nameplate Voltage (kV)', unit: '' },
  kv: { label: 'Nameplate Voltage (kV)', unit: '' },
  kv_ll: { label: 'Line-to-Line Voltage (kV)', unit: '' },
  Vm: { label: 'Calculated Voltage Magnitude', unit: 'p.u.' },
  Va: { label: 'Calculated Voltage Angle', unit: '°' },
  prefault_voltage: { label: 'Prefault Voltage', unit: 'kV' },
  kva: { label: 'kVA', unit: '' },
